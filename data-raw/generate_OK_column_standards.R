...
library(NVIdb)
library(usethis)
# The raw csv-file must first be generated by
source(file = file.path(set_dir_NVI("ProgrammeringR", slash = FALSE),
                           "standardization", "colnames", "Generate column_standards.R"),
          fileEncoding = "UTF-8")


OK_column_standards <- read.csv2(file = file.path(set_dir_NVI("ProgrammeringR", slash = FALSE),
                                                  "standardization", "colnames", "OK_column_standards.csv"),
                                 fileEncoding = "UTF-8")
standards$unique_colnames <- NULL
